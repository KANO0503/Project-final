...
if st.button("전송"):
    ...
    query = f"\"{menu_query}\" {destination} savorjapan.com/search-by-area/near_tokyo 사이트를 기반으로 입력된 도쿄 지역에 유명 명소 근처에 위치한 현재 영업중인 별 점수가 5점에 가까운 랭킹 1위~5위 맛집, 가게 리뷰, 상세 정보와 가게 정보(일본어 가게명과 매치된 주소,전화번호,영업시간,가격대) 함께 추천 해주세요"
